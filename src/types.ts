// Types shared by the public API and the internal modules
 ...
 */
export type ListenerFor<QueueItem extends Item, E extends ProcessQueueEvent> =
  IsUnion<E> extends true ? EventHandler<QueueItem> : ProcessQueueEvents<QueueItem>[E];

/**
 * Overflow strategies, in the order they are listed in error messages
 */
export const OVERFLOW_STRATEGIES = ['reject', 'drop-oldest', 'drop-newest'] as const;
